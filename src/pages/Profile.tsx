...
function Profile() {
  ...
  // Este useEffect diz que quando o dado vier da API ele deve ser atualizado no formulário
  // do perfil
  useEffect(() => {
    if (profileData) {
  ...
  const handleDelete = async () => {
    if (
      confirm(
        'Tem certeza que deseja excluir sua conta? Se sim, certifique-se de deletar os seus leds antes.'
      )
    ) {
      try {
